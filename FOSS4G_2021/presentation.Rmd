...
- First we decided to compare Arabesque to Arabesque, Flowmap.blue, Kepler.gl, Magrit and Flourish. Flourish is based on the same technologies as Kepler.gl, and does not bring much more than a pleasant interface. We have therefore chosen to discard it.
